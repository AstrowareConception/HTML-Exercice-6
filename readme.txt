...
On commence par faire un css-reset un css reset. Dans notre exercice, nous utilisons le reset le plus populaire de Eric Meyer disponible dans le fichier reset.css.
